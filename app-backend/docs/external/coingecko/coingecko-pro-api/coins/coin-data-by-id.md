...
````yaml reference/api-reference/coingecko-pro.json get /coins/{id}
openapi: 3.0.0
info:
...
components:
  schemas:
    CoinsID:
      allOf:
        - $ref: '#/components/schemas/CoinsIDDataBase'
      example:
        id: bitcoin
        symbol: btc
        name: Bitcoin
    ...
    CoinsIDDataBase:
      ...
      properties:
        ...
        detail_platforms:
          ...
          additionalProperties:
            $ref: '#/components/schemas/DetailPlatformData'
    ...
    DetailPlatformData:
      ...
      properties:
        decimal_place:
          type: number
          nullable: true
          description: decimal places for the token
        contract_address:
          type: string
