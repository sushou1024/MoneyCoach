...
| show_alternative | Include alternative currencies.                           | boolean | false         | Optional             |
| show_inactive    | Include historical/inactive currencies                    | boolean | false         | Optional             |

### Sample Request

```
curl --request GET \
     --url 'https://openexchangerates.org/api/currencies.json?prettyprint=false&show_alternative=false&show_inactive=false&app_id=aaa' \
